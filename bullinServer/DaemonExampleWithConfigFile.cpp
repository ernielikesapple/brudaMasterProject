...
#include "DaemonExampleWithConfigFile.hpp"
...
static void daemonize()
{
    ...
    stdin = fopen("/dev/null", "r");            //   /dev/null in Linux is a null device file. This will discard anything written to it, and will return EOF on reading. This is a command-line hack that acts as a vacuum, that sucks anything thrown to it.
